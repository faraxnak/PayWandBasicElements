...
extension UIFont {
    public enum TtroFonts : TtroFontProtocol {
        ...
        fileprivate func getFont() -> UIFont {
            ...
            case let .light(size):
                if Locale.current.languageCode == "ar" || Locale.current.languageCode == "fa" {
//                    return UIFont(name: "Dubai-Light", size: size)!
                    return UIFont(name: "IRANSansMobileFaNum-Light", size: size)! //Dubai-Light
                } else {
...
//                    return UIFont(name: "Dubai-Regular", size: size)!
                    return UIFont(name: "IRANSansMobileFaNum", size: size)! //Dubai-Regular
                } else {
            ...
            case let .semibold(size):
                if Locale.current.languageCode == "ar" || Locale.current.languageCode == "fa" {
//                    return UIFont(name: "Dubai-Regular", size: size)!
                    return UIFont(name: "IRANSansMobileFaNum-Bold", size: size)! //Dubai-Regular
                } else {
